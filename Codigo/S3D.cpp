...
void S3D::DefineQtdPoltrona()  // define nPoltrona para cada tipo de sala
{
...
bool S3D::EscolhePoltrona(string Nome_Poltrona, int *opi, int i)
{
...
string S3D::Nomepoltrona(int i, int j, int k)
{
