...
void Vip::DefineQtdPoltrona()  // define nPoltrona para cada tipo de sala
{
...
bool Vip::EscolhePoltrona(string Nome_Poltrona, int *opi, int i)
{
...
string Vip::Nomepoltrona(int i, int j, int k)
{
